...
public class UnityNewtonsoftJsonSerializer
{
        ...
        protected override IList<JsonProperty> CreateProperties(Type type, MemberSerialization memberSerialization)
        {
            ...
            for (Type t = type; t != null && !IsIgnoredType(t); t = t.BaseType)
            {
                ...
                for (int i = 0; i < currentTypeFields.Length; i++)
                {
                    ...
                    {
                        SacredTailsLog.LogErrorMessage("Failed to serialize a Unity object reference -- this is not supported by the " + GetType().Name
            ...
            for (int i = 0; i < allFields.Count; i++)
            {
                ...
                //SacredTailsLog.LogMessage(property.PropertyName + " was added.");
            }
            return properties;
        }
    }
    ...
    [SerializeField] private static bool prettyPrint = true;
